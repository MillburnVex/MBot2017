...
const int LIFT_MAX_VALUE = -2100;
const int LIFT_MIN_VALUE = -50;

// how different from each other the sides have to be when moving to be corrected
const int LIFT_CORRECTION_THRESHOLD = 30;
...
const int LIFT_HOLD_PASSIVE_POWER = 20; git

const int TICKS_UNTIL_HOLD = 3;
...
void Lift::Hold() {
    if (dropping || lifting) {
        ticksUntilHold = TICKS_UNTIL_HOLD;
        dropping = false;
        lifting = false;
    }
}
